...
public class ServiceProviderFunctionTest {
    ...
    public void ServiceProvider_constructorKey_test() {
        ...
        // Test the creation of an object and its getters
        try {
            ServiceProvider testServiceProvider = new ServiceProvider("key", "firstName", "lastName", "username", "{@TEST}", "passtest", "companyName", true, "{@TEST}", testAddressA, "description", 0, 0, 0, null);
    ...
    public void validate_Equals() {
        ...
        ServiceProvider testServiceProvider2a = new ServiceProvider("key", "firstName", "lastName", "username", "{@TEST}", "passtest", "companyName", true, "{@TEST}", testAddressA, "description", 0, 0, 0, null);
        ServiceProvider testServiceProvider2b = new ServiceProvider("key", "firstName", "lastName", "username", "{@TEST}", "passtest", "companyName", true, "{@TEST}", testAddressA, "description", 0, 0, 0, null);
        ServiceProvider testServiceProvider2c = new ServiceProvider("key", "firstName", "lastName", "username", "{@TEST}", "passtest", "companyNameDif", true, "{@TEST}", testAddressA, "description", 0, 0, 0, null);
        ServiceProvider testServiceProvider2d = new ServiceProvider("key", "firstName", "lastName", "username", "{@TEST}", "passtest", "companyName", false, "{@TEST}", testAddressA, "description", 0, 0, 0, null);
        ServiceProvider testServiceProvider2f = new ServiceProvider("key", "firstName", "lastName", "username", "{@TEST}", "passtest", "companyName", true, "{@TEST}", testAddressB, "description", 0, 0, 0, null);
        ServiceProvider testServiceProvider2g = new ServiceProvider("key", "firstName", "lastName", "username", "{@TEST}", "passtest", "companyName", true, "{@TEST}", testAddressA, "descriptionDif", 0, 0, 0, null);
        ServiceProvider testServiceProvider2h = new ServiceProvider("keyDif", "firstName", "lastName", "username", "{@TEST}", "passtest", "companyName", true, "{@TEST}", testAddressA, "descriptionDif", 0, 0, 0, null);
